import { dreamNote, statement } from "./Intro";

export function DreamExperiment() {
  return (
    <section className="manifesto dream-experiment section-shell" id="dream" data-scroll aria-labelledby="dream-title">
